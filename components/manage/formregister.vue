   ...
   computed: {
    ...
    methods: {
      ...
      validate(){
        ...
        //   }
        // })
        if( this.phoneState == false  || this.nameState == false || this.firstnameState == false || this.lastnameState == false ){
           validated = false
      ...
      onSubmit(evt){
        ...
        // this.$store.getters.getLine.userId
        db.collection("user").doc(this.$store.getters.getLine.userId).set(data)
          .then(function () {
