...
<b-container>
   <div>
    <b-button @click="show=true" variant="primary">เพิ่มหอพัก</b-button>
   ...
   <!--card-->
  <div class="card" style="width: 18rem;" v-for="user in users " :key="user">
  <img src="" class="card-img-top" alt="">
  <div class="card-body">
    <h5 class="card-title">{{user.idcard}}</h5>
